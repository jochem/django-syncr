...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.tag_list'
        db.alter_column('youtube_video', 'tag_list', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Video.tag_list'
        db.alter_column('youtube_video', 'tag_list', self.gf('django.db.models.fields.CharField')(max_length=250))
